...
function About() {
  return (
    <section className="text-yellow-600 body-font bg-yellow-600 border-15 border-dashed border-black">
      <div className="container px-5 py-14 mx-auto">
        <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
          <img
            src={logo}
            alt="Logo"
            className="inline-block w-25 h-25 mb-4 text-gray-400"
          />

          <p className=" text-3xl text-white font-georgia">
          ...
          <span className="inline-block h-1 w-10 rounded bg-yellow-600 mt-0 mb-6" />
